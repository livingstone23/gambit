...
func InsertOrder(o models.Orders) (int64, error) {
	...
	sentencia := "INSERT INTO order (Order_UserUUID, Order_Total, Order_AddId) Values ('"
	...
	for _, od := range o.OrdersDetails {
		sentencia = "INSERT INTO orders_detail (OD_OrderId, OD_ProdId, OD_ProdId, OD_Quantity, OD_Price) VALUES (" + strconv.Itoa(int(LastInsertId))
